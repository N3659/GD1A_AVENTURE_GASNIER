class Plage extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.tilemapTiledJSON("SceneForet", "Level_Design/Tiled/Foret.json");
    ...
    create (){
        ...
        const level = this.add.tilemap("ScenePlage");
        console.log("siu")
        const tileset = this.level.addTilesetImage("tileset","tileset_final");
        console.log("siu")
        const calque_Jardin = this.level.createLayer("Zone_Plage", tileset);
        console.log("siu")
