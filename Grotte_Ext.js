class Grotte_Ext extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.tilemapTiledJSON("SceneGrotteExt", "Level_Design/Tiled/Grotte_Ext.json");
    ...
    create (){
        ...
        const level = this.add.tilemap("SceneGrotteExt");
        console.log("siu")
        const tileset = this.level.addTilesetImage("tileset","tileset_final");
        console.log("siu")
        const calque_Jardin = this.level.createLayer("Zone_Grotte_Ext", tileset);
        console.log("siu")
